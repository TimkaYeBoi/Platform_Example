                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="director_name" required  value="{{$post->director_name}}">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" name="email" placeholder="you@example.com" required  value="{{$post->email}}">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="address" placeholder="1234 Main St" required  value="{{$post->address}}">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="phone_number" required  value="{{$post->phone_number}}">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="website" placeholder="example.com"  required  value="{{$post->website}}">
                                <div class="invalid-feedback">
                                    Введите вебсайт
                                </div>
                            </div>
